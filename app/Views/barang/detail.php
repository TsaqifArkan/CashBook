...
<!-- <div class="alert alert-breadcrumb-ave" role="alert">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 fs-6">
            <li class="breadcrumb-item"><a class="a-bread-ave" href="<?php //echo base_url('barang'); ?>">Barang</a></li>
...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-10">
            <a href="<?= base_url('barang'); ?>" type="button" class="btn btn-secondary">
                        ...
                        <div class="card-body p-4 pt-2">
                            <div class="table-responsive">
                                <div class="row mb-2 mx-0">
                                    <div class="col mx-0">
                                        <h4 class="text-dark"><strong><?= $namaBarang; ?> (<?= $namaSat; ?>)</strong>
                                        </h4>
                                    </div>
                                </div>
                                        ...
                                        <?php foreach ($data as $i => $d): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?=(esc($d['dk']) == 'D' ? 'Pemasukan' : 'Pengeluaran'); ?>
                                                </td>
