    ...
    <table class="table table-bordered table-hover" id="dataTable-Akun">
        <thead class="ave-bg-th">
            <tr>
                ...
                <th class="text-uppercase fw-bold">Saldo Normal</th>
                <th class="text-uppercase fw-bold">Saldo Awal</th>
        ...
        <tbody>
            <?php foreach ($datas as $i => $data): ?>
                <tr>
                    ...
                    <td><?= esc($data['saldonormal']); ?></td>
                    <td><?= esc($data['saldoawal']); ?></td>
                    <td>
                        <a href="<?= base_url('barang/detail') . '/' . esc($data['idakun']); ?>" class="btn btn-info btn-sm"
